/*
 * xnat-testatul: org.apache.turbine.app.xnat.modules.screens.XDATScreen_edit_testatul_biosampleCollection
...
import org.nrg.xdat.om.TestatulBiosamplecollection;
...
public class XDATScreen_edit_testatul_biosampleCollection extends EditSubjectAssessorScreen {
    @Override
    public String getElementName() {
        return TestatulBiosamplecollection.SCHEMA_ELEMENT_NAME;
    }
    ...
    public void finalProcessing(RunData data, Context context) {
        ...
        try {
            ...
            if (!context.containsKey("label")) {
                ...
                final List<XnatSubjectassessordata> biosamples = subject.getExperiments_experiment(TestatulBiosamplecollection.SCHEMA_ELEMENT_NAME);
